        ...
        <div>
            ...
            <div class="mb-[55px] md:text-center">
                ...
                <p
                    ...
                    Let's partner up and acheive your buisness goals together.</p>
            </div>
            <!-- Section title end -->
        ...
        <div
            ...
            <div class="flex items-center">
                ...
                <div class="ltr:pl-6 rtl:pr-6">
                    <h3
                        class="text-[28px] md:text-[22px] font-heebo font-bold text-primary dark:text-white">
                        Call Me</h3>
                    <span class="text-primary dark:text-slate-200 text-[22px] md:text-[18px] mt-5">+966 54
                        144 2781</span>
                </div>
            </div>
            ...
            <div class="flex items-center lg:mt-7">
                ...
                <div class="ltr:pl-6 rtl:pr-6">
                    <h3
                        ...
                        Email Me</h3>
                    <span
                        class="text-primary  dark:text-slate-200 text-[22px] md:text-[18px] mt-5">abdulrahman.mushref@yahoo.com
                        <br>
                        me@devmushref.com
                    </span>
                </div>
            ...
            <div class="flex items-center lg:mt-7">
                ...
                <div class="ltr:pl-6 rtl:pr-6">
                    <h3
                        ...
                        Address</h3>
                    <span
                        class="text-primary  dark:text-slate-200 text-[22px] md:text-[18px] mt-5">Jeddah,
                        <br>
                        Saudi Arabia
                    </span>
                </div>
