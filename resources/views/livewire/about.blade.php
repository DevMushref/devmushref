<div class="container mx-auto">
    <div class="flex justify-between sm:flex-wrap sm:flex-col-reverse">
        <div class="w-full lg:max-w-[550px]">
            <div>
                <span class="text-accent1 text-[20px] lg:text-[24px] font-medium mb-[10px] lg:mb-[5px]">ABOUT
                    ME</span>
                <h2 class="text-[24px] only-md:text-[32px] lg:text-[48px] font-bold font-heebo leading-[36px] lg:leading-[58px] text-[#000248] dark:text-white ltr:lg:pr-[50px] rtl:lg:pl-[50px]">
                    I can develop a world of leading websites & systems</h2>
            </div>
            <div class="mt-[30px]">
        ...
        <div class="sm:mb-[50px]">
            <div class="relative">
                <img class="relative z-10 sm:mx-auto" src="{{ asset('images/about-me.png') }}" alt="">
            ...
            <div class="text-center mt-[30px]">
                <h4 class="font-heebo text-[50px] lg:text-[80px] font-bold leading-[1] text-white title-stroke">
                    10+</h4>
                <span class="font-bold sm:text-[20px] only-md:text-[24px] lg:text-[30px] font-heebo text-primary dark:text-white">
                    Working Experience
                </span>
            </div>
        </div>
