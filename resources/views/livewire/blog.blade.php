        ...
        <div class="blog__card shadow-[0_0_50px_0_rgba(196,206,213,0.2)] hover:shadow-[0_0_100px_0_rgba(196,206,213,0.7)] dark:shadow-[0_0_20px_0_rgba(0,0,0,0.1)] dark:hover:shadow-[0_0_50px_0_rgba(0,0,0,0.2)] transition duration-500">
            <a class="block popup-modal--open" href="#">
                ...
                <div class="overflow-hidden">
                    <span class="block">
                        {{-- Blog image --}}
                        <img class="blog__thumb w-full transition duration-300" src="{{ asset('images/blog/1.png') }}" alt="">
                    </span>
                </div>
                <!-- blog image end -->
                ...
                <div class="p-[30px]">
                    ...
                    <div>
                        ...
                        <p class="mt-[15px] text-paragraph dark:text-slate-200 text-[17px]">
                            Post description. Lorem ipsum dolor sit amet,elit, sed do eiusmod tempor incididunt ut labore et dolore aliqu
                        </p>
                    </div>
                </div>
                <!-- blog content end -->
                        ...
                        <div>
                            <div class="pt-3">
                                <img class="max-w-full h-auto rounded-xl mt-6 mx-auto w-full"
                                    src="{{ asset('images/blog/blog-details-1.png') }}" alt="Blog details">
                            </div>
                            <h4 class="text-[25px] lg:text-[32px] leading-7 font-heebo font-bold mt-8">
                                <span class="text-primary dark:text-white">Angular team welarges to
                                    trequests blog</span>
                            </h4>
                            <div class="blog__content mt-5 text-[17px] leading-7 dark:text-slate-300">
                                <p>It is a long established fact that a reader will be distracted by the
                                    readable content of a page is
                                    when looking at its layout. The point of using Lorem Ipsum is that it
                                    has a more-or-less normal
                                    distribution of letters, as opposed to using ique maiestatis sum quod
                                    sum ut alienum nec et to
                                    summo possim persequeris vix mea. Adhuc quodsi qui, sit no tale essent
                                    electramei sum sums
                                    rodesset in pro, quo scripta feugait vidisse. Lorem ipsum dolor sit
                                    amet, eu duo ferri labor dicat
                                    Mea ex modo reque senserit, et sed hinc dolor, scaevola sum salutandi
                                    expetendis vix ne his
                                ...
                                <p class="mt-5">It is a long established fact that a reader will be
                                    distracted by the readable content of a page is
                                    when looking at its layout. The point of using Lorem Ipsum is that it
                                    has a more-or-less normal
                                ...
                                <blockquote
                                    ...
                                    <p>"Tailwind css is just awesome. It contains tons of predesigned
                            ...
                            <div class="mt-10">
                                ...
                                <div class="mt-7">
                                    ...
                                    <div class="flex gap-4 border-b border-gray-300 pb-7 dark:text-slate-300">
                                        <div class="w-20">
                                            <img src="{{ asset('images/blog/avatar.png') }}" alt="">
                                        </div>
                                        <div>
                                            <div class="flex items-center gap-3">
                                                <h6 class="text-primary font-heebo dark:text-white">Bonas
                                                    Mera</h6>
                                                <span>November 16, 2022</span>
                                            </div>
                                            <p class="py-2">Lorem ipsum is simply free textdolor sit
                                                amet, consectetur notted adipisicing elit sed do iusmod
                                                tempor incididu.</p>
                                            <button
                                                class="text-accent1 font-heebo font-bold text-[18px] transition-all duration-300 hover:text-primary bg-transparent">Reply</button>
                                        </div>
                                    </div>
                                    <!-- Single comment end -->
                                    ...
                                    <div class="flex gap-4 pt-7 pl-20 dark:text-slate-300">
                                        <div class="w-20">
                                            <img src="{{ asset('images/blog/avatar-2.png') }}" alt="">
                                        </div>
                                        <div>
                                            <div class="flex items-center gap-3">
                                                <h6 class="text-primary font-heebo dark:text-white">Jhone
                                                    Doe</h6>
